...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    public String register(RegistrationRequestDTO registrationRequestDTO) {
        ...
        User registeredUser = new User(registrationRequestDTO.getName(), registrationRequestDTO.getSurname(), registrationRequestDTO.getEmail(), registrationRequestDTO.getUsername(), encodedPassword, EStatus.NOT_VERIFIED);
